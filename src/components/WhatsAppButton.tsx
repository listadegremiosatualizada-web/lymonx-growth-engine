...
const options = [
    {
        id: 1,
        label: "Quero saber sobre automação",
        message: "Olá! Quero saber mais sobre automação.",
    },
    {
        id: 2,
        label: "Quero saber sobre site",
        message: "Olá! Quero saber mais sobre criação de sites.",
    },
    {
        id: 3,
        label: "Quero saber sobre o serviço completo",
        message: "Olá! Quero saber mais sobre o serviço completo.",
    },
];
                ...
                <div className="fixed bottom-24 right-6 z-50 w-72 rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-[#111] animate-in fade-in slide-in-from-bottom-4 duration-300">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-[#00FF00]/10 border-b border-white/10">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-semibold text-white">Como podemos ajudar?</span>
                        </div>
                        <button
